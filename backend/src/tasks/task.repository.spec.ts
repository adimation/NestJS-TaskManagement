...
describe('TaskRepository', () => {
  ...
  describe('getTasks', () => {
    ...
    it('throws error if retrieving tasks fails', async () => {
      queryMethods.getMany = jest.fn().mockRejectedValue(new InternalServerErrorException());
      filterDto = { status: null, search: null };
  ...
  describe('createTask', () => {
    ...
    it('creates a task', async () => {
      taskRepository.createTask = jest.fn().mockResolvedValue({ ...createTaskDto, status: TaskStatus.OPEN});
